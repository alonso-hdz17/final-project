    ...
    <div class="login">
      ...
      <form class="login-form" @submit.prevent="logUserIn">
        ...
        <router-link :to="{ path: '/signup' }">
          <button type="sign-up" class="register">New user? Sign up</button></router-link
        >
      </form>
    </div>
  </body>
...
.login {
  @apply mx-auto h-3/5 w-1/4 justify-center rounded-3xl bg-zinc-700 p-16 text-center;
}
.title {
