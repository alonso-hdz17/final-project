...
<template>
  <nav>
    ...
    <div v-else>
      ...
      <router-link :to="{ name: 'Services' }" class="menu-item">Services</router-link>
...
nav {
  @apply flex items-start justify-between space-x-2 px-5 py-4 text-slate-300;
  .title {
    @apply text-3xl font-bold;
  }
  .menu-item {
    @apply items-center justify-center space-x-2 px-5 font-semibold text-slate-300;
  }
  & .router-link-active {
    @apply font-bold italic underline underline-offset-4;
  }
}
</style>
